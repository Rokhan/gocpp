...
namespace golang::runtime
{
    ...
    const runtime::waitReason waitReasonGCAssistMarking = 1;
    const runtime::waitReason waitReasonIOWait = 2;
    const runtime::waitReason waitReasonChanReceiveNilChan = 3;
    const runtime::waitReason waitReasonChanSendNilChan = 4;
    const runtime::waitReason waitReasonDumpingHeap = 5;
    const runtime::waitReason waitReasonGarbageCollection = 6;
    const runtime::waitReason waitReasonGarbageCollectionScan = 7;
    const runtime::waitReason waitReasonPanicWait = 8;
    const runtime::waitReason waitReasonSelect = 9;
    const runtime::waitReason waitReasonSelectNoCases = 10;
    const runtime::waitReason waitReasonGCAssistWait = 11;
    const runtime::waitReason waitReasonGCSweepWait = 12;
    const runtime::waitReason waitReasonGCScavengeWait = 13;
    const runtime::waitReason waitReasonChanReceive = 14;
    const runtime::waitReason waitReasonChanSend = 15;
    const runtime::waitReason waitReasonFinalizerWait = 16;
    const runtime::waitReason waitReasonForceGCIdle = 17;
    const runtime::waitReason waitReasonSemacquire = 18;
    const runtime::waitReason waitReasonSleep = 19;
    const runtime::waitReason waitReasonSyncCondWait = 20;
    const runtime::waitReason waitReasonSyncMutexLock = 21;
    const runtime::waitReason waitReasonSyncRWMutexRLock = 22;
    const runtime::waitReason waitReasonSyncRWMutexLock = 23;
    const runtime::waitReason waitReasonTraceReaderBlocked = 24;
    const runtime::waitReason waitReasonWaitForGCCycle = 25;
    const runtime::waitReason waitReasonGCWorkerIdle = 26;
    const runtime::waitReason waitReasonGCWorkerActive = 27;
    const runtime::waitReason waitReasonPreempted = 28;
    const runtime::waitReason waitReasonDebugCall = 29;
    const runtime::waitReason waitReasonGCMarkTermination = 30;
    const runtime::waitReason waitReasonStoppingTheWorld = 31;
    const runtime::waitReason waitReasonFlushProcCaches = 32;
    const runtime::waitReason waitReasonTraceGoroutineStatus = 33;
    const runtime::waitReason waitReasonTraceProcStatus = 34;
    const runtime::waitReason waitReasonPageTraceFlush = 35;
    const runtime::waitReason waitReasonCoroutine = 36;
}
