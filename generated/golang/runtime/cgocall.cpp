...
namespace golang::runtime
{
    ...
    {
        auto as = gocpp::Init<golang::runtime::argset>([=](auto& x) {
    ...
    void cgocallbackg1(gocpp::unsafe_pointer fn, gocpp::unsafe_pointer frame, uintptr_t ctxt)
    {
        ...
        try
        {
            ...
            if(ctxt != 0)
            {
                ...
                defer.push_back([=]{ [=](golang::runtime::g* gp) mutable -> void
                {
            ...
            auto cbFV = golang::runtime::funcval {uintptr_t(fn)};
            ...
            //Go switch emulation
            {
                ...
                switch(conditionId)
                {
                    case 0:
                    {
                        ...
                        auto pt = (golang::runtime::ptrtype*)(gocpp::unsafe_pointer(t));
    ...
    void cgoCheckArg(_type* t, gocpp::unsafe_pointer p, bool indir, bool top, gocpp::string msg)
    {
        ...
        //Go switch emulation
        {
            ...
            switch(conditionId)
            {
                ...
                case 4:
                {
                    auto it = *(golang::runtime::_type**)(p);
                    if(it == nullptr)
                    {
                        return;
                    }
                ...
                case 5:
                {
                    auto st = (golang::runtime::slicetype*)(gocpp::unsafe_pointer(t));
                ...
                case 6:
                {
                    auto ss = (golang::runtime::stringStruct*)(p);
