...
namespace golang::registry
{
    ...
    std::tuple<int, uint32_t, gocpp::error> rec::GetValue(Key k, gocpp::string name, gocpp::slice<unsigned char> buf)
    {
        int n;
        uint32_t valtype;
        gocpp::error err;
    ...
    std::tuple<gocpp::slice<unsigned char>, uint32_t, gocpp::error> rec::getValue(Key k, gocpp::string name, gocpp::slice<unsigned char> buf)
    {
    ...
    std::tuple<gocpp::string, uint32_t, gocpp::error> rec::GetStringValue(Key k, gocpp::string name)
    {
        gocpp::string val;
        uint32_t valtype;
        gocpp::error err;
    ...
    std::tuple<gocpp::string, gocpp::error> rec::GetMUIStringValue(Key k, gocpp::string name)
    {
    ...
    // type and ErrUnexpectedType.
    std::tuple<gocpp::slice<gocpp::string>, uint32_t, gocpp::error> rec::GetStringsValue(Key k, gocpp::string name)
    {
    ...
    // type and ErrUnexpectedType.
    std::tuple<uint64_t, uint32_t, gocpp::error> rec::GetIntegerValue(Key k, gocpp::string name)
    {
        uint64_t val;
        uint32_t valtype;
        gocpp::error err;
    ...
    // type and ErrUnexpectedType.
    std::tuple<gocpp::slice<unsigned char>, uint32_t, gocpp::error> rec::GetBinaryValue(Key k, gocpp::string name)
    {
    ...
    gocpp::error rec::setValue(Key k, gocpp::string name, uint32_t valtype, gocpp::slice<unsigned char> data)
    {
    ...
    gocpp::error rec::SetDWordValue(Key k, gocpp::string name, uint32_t value)
    {
    ...
    gocpp::error rec::SetQWordValue(Key k, gocpp::string name, uint64_t value)
    {
    ...
    gocpp::error rec::setStringValue(Key k, gocpp::string name, uint32_t valtype, gocpp::string value)
    {
    ...
    gocpp::error rec::SetStringValue(Key k, gocpp::string name, gocpp::string value)
    {
    ...
    gocpp::error rec::SetExpandStringValue(Key k, gocpp::string name, gocpp::string value)
    {
    ...
    gocpp::error rec::SetStringsValue(Key k, gocpp::string name, gocpp::slice<gocpp::string> value)
    {
        auto ss = ""_s;
    ...
    gocpp::error rec::SetBinaryValue(Key k, gocpp::string name, gocpp::slice<unsigned char> value)
    {
    ...
    std::tuple<gocpp::slice<gocpp::string>, gocpp::error> rec::ReadValueNames(Key k)
    {
