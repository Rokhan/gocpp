...
namespace golang::zlib
{
    ...
    namespace rec
    {
        std::tuple<int, gocpp::error> Read(reader* z, gocpp::slice<unsigned char> p);
        gocpp::error Close(reader* z);
        gocpp::error Reset(reader* z, io::Reader r, gocpp::slice<unsigned char> dict);
    }
}
