...
namespace golang::errors
{
    ...
    bool As(struct gocpp::error err, go_any target)
    {
        ...
        if(target == nullptr)
        {
            gocpp::panic("errors: target cannot be nil"_s);
        }
        ...
        {
            gocpp::panic("errors: target must be a non-nil pointer"_s);
        }
        ...
        {
            gocpp::panic("errors: *target must be interface or implement error"_s);
        }
