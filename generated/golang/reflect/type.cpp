...
namespace golang::reflect
{
    ...
    struct Type MapOf(struct Type key, struct Type elem)
    {
        ...
        mt.Hasher = [=](gocpp::unsafe_pointer p, uintptr_t seed) mutable -> uintptr_t
        {
    ...
    gocpp::string funcStr(golang::reflect::funcType* ft)
    {
        ...
        for(auto [i, t] : rec::InSlice(gocpp::recv(ft)))
        {
            ...
            {
                repr = append(repr, "..."_s);
                repr = append(repr, stringFor((sliceType*)(gocpp::unsafe_pointer(t))->Elem));
            }
            else
            {
    ...
    struct Type StructOf(gocpp::slice<StructField> fields)
    {
        ...
        try
        {
            ...
            *typ = *prototype;
            ...
            if(comparable)
            {
                typ->Equal = [=](gocpp::unsafe_pointer p, gocpp::unsafe_pointer q) mutable -> bool
                {
    ...
    struct Type ArrayOf(int length, struct Type elem)
    {
        ...
        {
            array.Equal = [=](gocpp::unsafe_pointer p, gocpp::unsafe_pointer q) mutable -> bool
            {
