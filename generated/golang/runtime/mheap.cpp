...
namespace golang::runtime
{
    ...
    //go:nosplit
    mSpanState rec::get(mSpanStateBox* b)
    {
    ...
    mspan* rec::alloc(mheap* h, uintptr_t npages, spanClass spanclass)
    {
    ...
    //
    //go:systemstack
    mspan* rec::allocManual(mheap* h, uintptr_t npages, spanAllocType typ)
    {
    ...
    //
    //go:systemstack
    mspan* rec::tryAllocMSpan(mheap* h)
    {
    ...
    //
    //go:systemstack
    mspan* rec::allocMSpanLocked(mheap* h)
    {
        assertLockHeld(& h->lock);
    ...
    //
    //go:systemstack
    mspan* rec::allocSpan(mheap* h, uintptr_t npages, spanAllocType typ, spanClass spanclass)
    {
        mspan* s;
    ...
    std::tuple<special**, bool> rec::specialFindSplicePoint(mspan* span, uintptr_t offset, unsigned char kind)
    {
        // Find splice point, check for existing record.
    ...
    special* rec::unlinkAndNext(specialsIter* i)
    {
        auto cur = i->s;
        i->s = cur->next;
        *i->pprev = i->s;
    ...
    gcBits* rec::tryAlloc(gcBitsArena* b, uintptr_t bytes)
    {
