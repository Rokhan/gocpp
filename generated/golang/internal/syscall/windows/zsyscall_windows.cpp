...
namespace golang::windows
{
    ...
    syscall::LazyDLL* modbcryptprimitives = syscall::NewLazyDLL(sysdll::Add("bcryptprimitives.dll"_s));
    ...
    syscall::LazyProc* procUnlockFileEx = rec::NewProc(gocpp::recv(modkernel32), "UnlockFileEx"_s);
