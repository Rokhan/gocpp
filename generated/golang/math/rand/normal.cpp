...
namespace golang::rand
{
    ...
    gocpp::array<uint32_t, 128> kn = gocpp::array<uint32_t, 128> {
    ...
    gocpp::array<float, 128> wn = gocpp::array<float, 128> {
    ...
    gocpp::array<float, 128> fn = gocpp::array<float, 128> {
