...
namespace golang::bytes
{
    ...
    gocpp::slice<unsigned char> rec::Bytes(Buffer* b)
    {
    ...
    gocpp::slice<unsigned char> rec::AvailableBuffer(Buffer* b)
    {
    ...
    int rec::Cap(Buffer* b)
    {
        return cap(b->buf);
    }

    // Available returns how many bytes are unused in the buffer.
    int rec::Available(Buffer* b)
    {
    ...
    void rec::Truncate(Buffer* b, int n)
    {
        if(n == 0)
        {
    ...
    std::tuple<int, bool> rec::tryGrowByReslice(Buffer* b, int n)
    {
    ...
    std::tuple<int, gocpp::error> rec::Write(Buffer* b, gocpp::slice<unsigned char> p)
    {
        int n;
        gocpp::error err;
        b->lastRead = opInvalid;
    ...
    std::tuple<int, gocpp::error> rec::WriteString(Buffer* b, gocpp::string s)
    {
        int n;
        gocpp::error err;
        b->lastRead = opInvalid;
    ...
    std::tuple<int64_t, gocpp::error> rec::ReadFrom(Buffer* b, io::Reader r)
    {
        int64_t n;
        gocpp::error err;
        b->lastRead = opInvalid;
    ...
    // [ErrTooLarge].
    gocpp::error rec::WriteByte(Buffer* b, unsigned char c)
    {
        b->lastRead = opInvalid;
    ...
    gocpp::slice<unsigned char> rec::Next(Buffer* b, int n)
    {
        b->lastRead = opInvalid;
        auto m = rec::Len(gocpp::recv(b));
        if(n > m)
    ...
    std::tuple<gocpp::rune, int, gocpp::error> rec::ReadRune(Buffer* b)
    {
        gocpp::rune r;
        int size;
        gocpp::error err;
    ...
    gocpp::error rec::UnreadRune(Buffer* b)
    {
    ...
    gocpp::error rec::UnreadByte(Buffer* b)
    {
        if(b->lastRead == opInvalid)
        {
    ...
    std::tuple<gocpp::slice<unsigned char>, gocpp::error> rec::readSlice(Buffer* b, unsigned char delim)
    {
        gocpp::slice<unsigned char> line;
        gocpp::error err;
