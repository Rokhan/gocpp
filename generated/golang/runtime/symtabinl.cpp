...
namespace golang::runtime
{
    ...
    bool rec::isInlined(inlineUnwinder* u, inlineFrame uf)
    {
        return uf.index >= 0;
    }
    ...
    std::tuple<gocpp::string, int> rec::fileLine(inlineUnwinder* u, inlineFrame uf)
    {
        gocpp::string file;
        int line;
        int32_t line32;
