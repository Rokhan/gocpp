...
| $(ImportDir)/compress/flate/huffman_code.go | ✔️ ([cpp](generated/golang/compress/flate/huffman_code.cpp), [h](generated/golang/compress/flate/huffman_code.h))| ✔️ |
...
| $(ImportDir)/encoding/json/decode.go | ✔️ ([cpp](generated/golang/encoding/json/decode.cpp), [h](generated/golang/encoding/json/decode.h))| ❌ |
| $(ImportDir)/encoding/json/encode.go | ✔️ ([cpp](generated/golang/encoding/json/encode.cpp), [h](generated/golang/encoding/json/encode.h))| ❌ |
| $(ImportDir)/encoding/json/fold.go | ✔️ ([cpp](generated/golang/encoding/json/fold.cpp), [h](generated/golang/encoding/json/fold.h))| ✔️ |
| $(ImportDir)/encoding/json/indent.go | ✔️ ([cpp](generated/golang/encoding/json/indent.cpp), [h](generated/golang/encoding/json/indent.h))| ❌ |
| $(ImportDir)/encoding/json/scanner.go | ✔️ ([cpp](generated/golang/encoding/json/scanner.cpp), [h](generated/golang/encoding/json/scanner.h))| ❌ |
| $(ImportDir)/encoding/json/stream.go | ✔️ ([cpp](generated/golang/encoding/json/stream.cpp), [h](generated/golang/encoding/json/stream.h))| ❌ |
| $(ImportDir)/encoding/json/tables.go | ✔️ ([cpp](generated/golang/encoding/json/tables.cpp), [h](generated/golang/encoding/json/tables.h))| ✔️ |
| $(ImportDir)/encoding/json/tags.go | ✔️ ([cpp](generated/golang/encoding/json/tags.cpp), [h](generated/golang/encoding/json/tags.h))| ❌ |
...
| $(ImportDir)/go/build/gc.go | ✔️ ([cpp](generated/golang/go/build/gc.cpp), [h](generated/golang/go/build/gc.h))| ✔️ |
| $(ImportDir)/go/build/read.go | ✔️ ([cpp](generated/golang/go/build/read.cpp), [h](generated/golang/go/build/read.h))| ❌ |
| $(ImportDir)/go/build/syslist.go | ✔️ ([cpp](generated/golang/go/build/syslist.cpp), [h](generated/golang/go/build/syslist.h))| ✔️ |
| $(ImportDir)/go/build/zcgo.go | ✔️ ([cpp](generated/golang/go/build/zcgo.cpp), [h](generated/golang/go/build/zcgo.h))| ✔️ |
...
| $(ImportDir)/go/internal/typeparams/typeparams.go | ✔️ ([cpp](generated/golang/go/internal/typeparams/typeparams.cpp), [h](generated/golang/go/internal/typeparams/typeparams.h))| ✔️ |
...
| $(ImportDir)/go/scanner/scanner.go | ✔️ ([cpp](generated/golang/go/scanner/scanner.cpp), [h](generated/golang/go/scanner/scanner.h))| ✔️ |
...
| $(ImportDir)/go/types/util.go | ✔️ ([cpp](generated/golang/go/types/util.cpp), [h](generated/golang/go/types/util.h))| ✔️ |
...
| $(ImportDir)/golang.org/x/sync/errgroup/go120.go | ✔️ ([cpp](generated/golang/golang.org/x/sync/errgroup/go120.cpp), [h](generated/golang/golang.org/x/sync/errgroup/go120.h))| ✔️ |
...
| $(ImportDir)/golang.org/x/tools/internal/gcimporter/bimport.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/gcimporter/bimport.cpp), [h](generated/golang/golang.org/x/tools/internal/gcimporter/bimport.h))| ❌ |
| $(ImportDir)/golang.org/x/tools/internal/gcimporter/exportdata.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/gcimporter/exportdata.cpp), [h](generated/golang/golang.org/x/tools/internal/gcimporter/exportdata.h))| ✔️ |
...
| $(ImportDir)/golang.org/x/tools/internal/gcimporter/newInterface11.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/gcimporter/newInterface11.cpp), [h](generated/golang/golang.org/x/tools/internal/gcimporter/newInterface11.h))| ❌ |
| $(ImportDir)/golang.org/x/tools/internal/gcimporter/support_go118.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/gcimporter/support_go118.cpp), [h](generated/golang/golang.org/x/tools/internal/gcimporter/support_go118.h))| ❌ |
| $(ImportDir)/golang.org/x/tools/internal/gcimporter/ureader_yes.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/gcimporter/ureader_yes.cpp), [h](generated/golang/golang.org/x/tools/internal/gcimporter/ureader_yes.h))| ❌ |
...
| $(ImportDir)/golang.org/x/tools/internal/pkgbits/frames_go17.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/pkgbits/frames_go17.cpp), [h](generated/golang/golang.org/x/tools/internal/pkgbits/frames_go17.h))| ❌ |
...
| $(ImportDir)/golang.org/x/tools/internal/tokeninternal/tokeninternal.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/tokeninternal/tokeninternal.cpp), [h](generated/golang/golang.org/x/tools/internal/tokeninternal/tokeninternal.h))| ❌ |
...
| $(ImportDir)/golang.org/x/tools/internal/versions/features.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/versions/features.cpp), [h](generated/golang/golang.org/x/tools/internal/versions/features.h))| ✔️ |
| $(ImportDir)/golang.org/x/tools/internal/versions/gover.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/versions/gover.cpp), [h](generated/golang/golang.org/x/tools/internal/versions/gover.h))| ✔️ |
| $(ImportDir)/golang.org/x/tools/internal/versions/types_go122.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/versions/types_go122.cpp), [h](generated/golang/golang.org/x/tools/internal/versions/types_go122.h))| ❌ |
| $(ImportDir)/golang.org/x/tools/internal/versions/versions.go | ✔️ ([cpp](generated/golang/golang.org/x/tools/internal/versions/versions.cpp), [h](generated/golang/golang.org/x/tools/internal/versions/versions.h))| ✔️ |
| $(ImportDir)/golang.org/x/tour/pic/pic.go | ✔️ ([cpp](generated/golang/golang.org/x/tour/pic/pic.cpp), [h](generated/golang/golang.org/x/tour/pic/pic.h))| ✔️ |
| $(ImportDir)/golang.org/x/tour/reader/validate.go | ✔️ ([cpp](generated/golang/golang.org/x/tour/reader/validate.cpp), [h](generated/golang/golang.org/x/tour/reader/validate.h))| ✔️ |
...
| $(ImportDir)/internal/goroot/gc.go | ✔️ ([cpp](generated/golang/internal/goroot/gc.cpp), [h](generated/golang/internal/goroot/gc.h))| ✔️ |
...
| $(ImportDir)/internal/poll/hook_windows.go | ✔️ ([cpp](generated/golang/internal/poll/hook_windows.cpp), [h](generated/golang/internal/poll/hook_windows.h))| ✔️ |
...
| $(ImportDir)/internal/safefilepath/path_windows.go | ✔️ ([cpp](generated/golang/internal/safefilepath/path_windows.cpp), [h](generated/golang/internal/safefilepath/path_windows.h))| ✔️ |
...
| $(ImportDir)/os/exec/lp_windows.go | ✔️ ([cpp](generated/golang/os/exec/lp_windows.cpp), [h](generated/golang/os/exec/lp_windows.h))| ✔️ |
...
| $(ImportDir)/os/executable.go | ✔️ ([cpp](generated/golang/os/executable.cpp), [h](generated/golang/os/executable.h))| ✔️ |
| $(ImportDir)/os/executable_windows.go | ✔️ ([cpp](generated/golang/os/executable_windows.cpp), [h](generated/golang/os/executable_windows.h))| ✔️ |
...
| $(ImportDir)/os/path.go | ✔️ ([cpp](generated/golang/os/path.cpp), [h](generated/golang/os/path.h))| ✔️ |
| $(ImportDir)/os/path_windows.go | ✔️ ([cpp](generated/golang/os/path_windows.cpp), [h](generated/golang/os/path_windows.h))| ✔️ |
| $(ImportDir)/os/proc.go | ✔️ ([cpp](generated/golang/os/proc.cpp), [h](generated/golang/os/proc.h))| ✔️ |
| $(ImportDir)/os/rawconn.go | ✔️ ([cpp](generated/golang/os/rawconn.cpp), [h](generated/golang/os/rawconn.h))| ❌ |
| $(ImportDir)/os/removeall_noat.go | ✔️ ([cpp](generated/golang/os/removeall_noat.cpp), [h](generated/golang/os/removeall_noat.h))| ❌ |
...
| $(ImportDir)/os/tempfile.go | ✔️ ([cpp](generated/golang/os/tempfile.cpp), [h](generated/golang/os/tempfile.h))| ✔️ |
...
| $(ImportDir)/runtime/cpuflags.go | ✔️ ([cpp](generated/golang/runtime/cpuflags.cpp), [h](generated/golang/runtime/cpuflags.h))| ✔️ |
...
| $(ImportDir)/strconv/atob.go | ✔️ ([cpp](generated/golang/strconv/atob.cpp), [h](generated/golang/strconv/atob.h))| ✔️ |
| $(ImportDir)/strconv/atof.go | ✔️ ([cpp](generated/golang/strconv/atof.cpp), [h](generated/golang/strconv/atof.h))| ✔️ |
...
| $(ImportDir)/strconv/itoa.go | ✔️ ([cpp](generated/golang/strconv/itoa.cpp), [h](generated/golang/strconv/itoa.h))| ✔️ |
...
| $(ImportDir)/sync/oncefunc.go | ✔️ ([cpp](generated/golang/sync/oncefunc.cpp), [h](generated/golang/sync/oncefunc.h))| ✔️ |
...
| $(ImportDir)/syscall/msan0.go | ✔️ ([cpp](generated/golang/syscall/msan0.cpp), [h](generated/golang/syscall/msan0.h))| ✔️ |
...
| $(ImportDir)/unicode/graphic.go | ✔️ ([cpp](generated/golang/unicode/graphic.cpp), [h](generated/golang/unicode/graphic.h))| ✔️ |
| $(ImportDir)/unicode/letter.go | ✔️ ([cpp](generated/golang/unicode/letter.cpp), [h](generated/golang/unicode/letter.h))| ❌ |
| $(ImportDir)/unicode/tables.go | ✔️ ([cpp](generated/golang/unicode/tables.cpp), [h](generated/golang/unicode/tables.h))| ✔️ |
