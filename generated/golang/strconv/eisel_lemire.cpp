...
namespace golang::strconv
{
    std::tuple<double, bool> eiselLemire64(uint64_t man, int exp10, bool neg)
    {
        ...
        auto clz = LeadingZeros64(gocpp::recv(bits), man);
        ...
        auto [xHi, xLo] = Mul64(gocpp::recv(bits), man, detailedPowersOfTen[exp10 - detailedPowersOfTenMinExp10][1]);
        if(xHi & 0x1FF == 0x1FF && xLo + man < man)
        {
            double f;
            bool ok;
            auto [yHi, yLo] = Mul64(gocpp::recv(bits), man, detailedPowersOfTen[exp10 - detailedPowersOfTenMinExp10][0]);
