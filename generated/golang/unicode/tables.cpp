...
namespace golang::unicode
{
    ...
    gocpp::map<std::string, RangeTable*> Categories = gocpp::map<std::string, RangeTable*> {{ "C", C }, { "Cc", Cc }, { "Cf", Cf }, { "Co", Co }, { "Cs", Cs }, { "L", L }, { "Ll", Ll }, { "Lm", Lm }, { "Lo", Lo }, { "Lt", Lt }, { "Lu", Lu }, { "M", M }, { "Mc", Mc }, { "Me", Me }, { "Mn", Mn }, { "N", N }, { "Nd", Nd }, { "Nl", Nl }, { "No", No }, { "P", P }, { "Pc", Pc }, { "Pd", Pd }, { "Pe", Pe }, { "Pf", Pf }, { "Pi", Pi }, { "Po", Po }, { "Ps", Ps }, { "S", S }, { "Sc", Sc }, { "Sk", Sk }, { "Sm", Sm }, { "So", So }, { "Z", Z }, { "Zl", Zl }, { "Zp", Zp }, { "Zs", Zs }};
    ...
    gocpp::map<std::string, RangeTable*> FoldCategory = gocpp::map<std::string, RangeTable*> {{ "L", foldL }, { "Ll", foldLl }, { "Lt", foldLt }, { "Lu", foldLu }, { "M", foldM }, { "Mn", foldMn }};
    ...
    gocpp::map<std::string, RangeTable*> FoldScript = gocpp::map<std::string, RangeTable*> {{ "Common", foldCommon }, { "Greek", foldGreek }, { "Inherited", foldInherited }};
