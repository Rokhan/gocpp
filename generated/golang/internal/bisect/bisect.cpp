...
namespace golang::bisect
{
    ...
    std::string printFileLine(Writer w, uint64_t h, std::string file, int line)
    {
        ...
        b = append(b, '\n');
        auto [_, err] = Write(gocpp::recv(w), b);
        return err;
    }
    ...
    uint64_t Hash(gocpp::slice<go_any> data)
    {
        ...
        for(auto [_, v] : data)
        {
            //Go type switch emulation
            {
                ...
                int conditionId = -1;
                else if(gocpp_id_0 == typeid(std::string)) { conditionId = 0; }
                else if(gocpp_id_0 == typeid(unsigned char)) { conditionId = 1; }
                else if(gocpp_id_0 == typeid(int)) { conditionId = 2; }
                else if(gocpp_id_0 == typeid(unsigned int)) { conditionId = 3; }
                else if(gocpp_id_0 == typeid(int32_t)) { conditionId = 4; }
                else if(gocpp_id_0 == typeid(uint32_t)) { conditionId = 5; }
                else if(gocpp_id_0 == typeid(int64_t)) { conditionId = 6; }
                else if(gocpp_id_0 == typeid(uint64_t)) { conditionId = 7; }
                else if(gocpp_id_0 == typeid(uintptr_t)) { conditionId = 8; }
                else if(gocpp_id_0 == typeid(gocpp::slice<std::string>)) { conditionId = 9; }
                else if(gocpp_id_0 == typeid(gocpp::slice<unsigned char>)) { conditionId = 10; }
                else if(gocpp_id_0 == typeid(gocpp::slice<int>)) { conditionId = 11; }
                else if(gocpp_id_0 == typeid(gocpp::slice<unsigned int>)) { conditionId = 12; }
                else if(gocpp_id_0 == typeid(gocpp::slice<int32_t>)) { conditionId = 13; }
                else if(gocpp_id_0 == typeid(gocpp::slice<uint32_t>)) { conditionId = 14; }
                else if(gocpp_id_0 == typeid(gocpp::slice<int64_t>)) { conditionId = 15; }
                else if(gocpp_id_0 == typeid(gocpp::slice<uint64_t>)) { conditionId = 16; }
                else if(gocpp_id_0 == typeid(gocpp::slice<uintptr_t>)) { conditionId = 17; }
                switch(conditionId)
                {
                    default:
                    {
